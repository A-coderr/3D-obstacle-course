...
export default class Game {
  ...
  async init() {
    ...
    this.rapierRenderer = new RapierRenderer(this.scene, this.world)
    this.rapierRenderer.enabled = false
    const gui = new GUI()
    gui.add(this.rapierRenderer, 'enabled').name('Rapier Renderer')
