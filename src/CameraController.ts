...
export default class FollowCam {
  ...
  /**
   * Constructs a FollowCam object.
   * @param {Scene} scene The scene containing the camera.
   * @param {PerspectiveCamera} camera The camera to be moved.
   * @param {WebGLRenderer} renderer The WebGL renderer containing the camera.
   */
  constructor(
    scene: Scene,
    camera: PerspectiveCamera,
